...
if (!self.__WB_pmw) {
    ...
    function audioFromMic() {
        ...
        try {
            ...
            var e = {};
            e.googEchoCancellation = "false", e["googAutoGainControl"] = "false", e["googNoiseSuppression"] = "false", e["googHighpassFilter"] = "false";
            var t = {};
            t["mandatory"] = e, t.optional = [];
            var a = {};
            a.audio = t, navigator["getUserMedia"](a, gotStream, didntGetStream)
        } catch (e) {
            return void alert("getUserMedia threw exception :" + e)
        }
        document.getElementsByClassName("use-files")[0].style.visibility = "hidden", document.getElementsByClassName("use-files")[0].style.transition = "all 0.0s", document.getElementsByClassName("readout-group")[0].style.visibility = "visible", document.getElementById("meter").style.visibility = "visible", document.getElementById("settings_button").style.visibility = "visible", document.getElementById("readout").style.visibility = "visible", document.getElementById("beta_mic").style.visibility = "visible", drawLoop()
    }
    ...
    function audioFromFile() {
        if (window["File"] && window["FileReader"]) {
            try {
                window["AudioContext"] = window["AudioContext"] || window["webkitAudioContext"], createAudioMeter(audioContext = new AudioContext, !0), bufferSource = audioContext.createBufferSource()
            } catch (e) {
    ...
    function decode(e, t) {
        try {
            audioContext["decodeAudioData"](e, function(e) {
                ResetAll(), volumeAudioProcess(e), fileProgress["push"](0), fileProgress[fileProgress["length"] - 1] = 1, printLoudnessFromFile(t)
            }, function() {
                fileProgress["push"](0), fileProgress[fileProgress["length"] - 1] = 1, alert("Error decoding: " + t["name"])
            })
        } catch (e) {
    ...
    function responsiveCanvas() {
        ...
        canvasContext["canvas"]["width"] = WIDTH * GuiScaling, canvasContext.canvas["height"] = HEIGHT * GuiScaling, canvasContext["canvas"].style["width"] = String(WIDTH) + "px", canvasContext["canvas"].style["height"] = String(HEIGHT) + "px", canvasContext["scale"](GuiScaling, GuiScaling)
    }
    ...
    function drawMainMeter(e, t, a, x, s, n, i) {
        canvasContext["fillStyle"] = "white", canvasContext["strokeStyle"] = "white", canvasContext["font"] = t + "px Lato";
        var r = x + 2 * t;
    ...
    class MovingAverage {
        constructor() {
            this["delayObject"] = new Delay, this["out"] = 0, this["samplesize"] = 0
        } ["average"](e) {
            var t = this["delayObject"]["delay_in_samples"](e, this["samplesize"]);
            return this["out"] = this["out"] + e - t, this.out / this.samplesize
        }
        setup_moving_average(e, t) {
            this["samplesize"] = e * t * .001, this["reset"]()
        } ["reset"]() {
            this["delayObject"]["reset"](), this["out"] = 0
        }
    }
    class KWeightFilter {
        constructor() {
            this["biquad_one_coeffs_48kHz"] = {}, this["biquad_one_coeffs_48kHz"].fs = 48e3, this["biquad_one_coeffs_48kHz"].a1 = -1.69065929318241, this["biquad_one_coeffs_48kHz"].a2 = .73248077421585, this["biquad_one_coeffs_48kHz"].b0 = 1.53512485958697, this["biquad_one_coeffs_48kHz"].b1 = -2.69169618940638, this["biquad_one_coeffs_48kHz"].b2 = 1.19839281085285, this["biquad_two_coeffs_48kHz"] = {}, this["biquad_two_coeffs_48kHz"].fs = 48e3, this["biquad_two_coeffs_48kHz"].a1 = -1.99004745483398, this["biquad_two_coeffs_48kHz"].a2 = .99007225036621, this["biquad_two_coeffs_48kHz"].b0 = 1, this["biquad_two_coeffs_48kHz"].b1 = -2, this["biquad_two_coeffs_48kHz"].b2 = 1, this["biquad_one_coeffs"] = {}, this["biquad_one_coeffs"].fs = 0, this["biquad_one_coeffs"].a1 = 0, this["biquad_one_coeffs"].a2 = 0, this["biquad_one_coeffs"].b0 = 0, this["biquad_one_coeffs"].b1 = 0, this["biquad_one_coeffs"].b2 = 0, this["biquad_two_coeffs"] = {}, this["biquad_two_coeffs"].fs = 0, this["biquad_two_coeffs"].a1 = 0, this["biquad_two_coeffs"].a2 = 0, this["biquad_two_coeffs"].b0 = 0, this["biquad_two_coeffs"].b1 = 0, this["biquad_two_coeffs"].b2 = 0, this["in1"] = 0, this["in2"] = 0, this["out1"] = 0, this["out2"] = 0, this["out"] = 0, this["_in1"] = 0, this["_in2"] = 0, this["_out1"] = 0, this["_out2"] = 0, this["_out"] = 0
        } ["biquad_get_ps"](e, t) {
            var a = e.a1 - 2,
                x = e.a1,
                s = -e.a1 - 2,
    ...
    class AverageContinuous {
        constructor() {
            ...
            return this["sum"] += e, this["count"]++, this.sum / this["count"]
        } ["reset"]() {
            this["count"] = 0, this["sum"] = 0
        }
    }
    class HoldMax {
        constructor() {
            ...
            return this["out"] = Math["max"](this["out"], e), this["out"]
        } ["reset"]() {
            this.out = -999999
        }
    }
    ...
    function ResetAll() {
        envelopeObject["reset"](), averageVolumeObject["reset"](), loudnessObject.reset(), integratedObject["reset"](), maxVolumeObject["reset"](), maxMomentaryObject["reset"](), maxShortObject.reset(), values["volume"] = -200, values["momentaryLoudness"] = -200, values["shortTermLoudness"] = -200, values["integratedLoudness"] = -200, values.volumeMax = -200, values["momentaryLoudnessMax"] = -200, values["shortTermLoudnessMax"] = -200, values.volumeAveraged = -200, values["integratedLoudness"] = -200, RefreshCount = 0
    }

    function ResetHoldMax() {
        maxVolumeObject["reset"](), maxMomentaryObject["reset"](), maxShortObject["reset"](), values["volumeMax"] = -200, values.momentaryLoudnessMax = -200, values["shortTermLoudnessMax"] = -200
    }

    function ResetAverage() {
        averageVolumeObject["reset"](), integratedObject.reset(), values["volumeAveraged"] = -200, values["integratedLoudness"] = -200
    }
