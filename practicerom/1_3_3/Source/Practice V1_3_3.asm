...
Start:
	...
	EveryFrameFunctions2:
		...
		JAL 	OpenMenu
		NOP
		JAL 	UpdateMenuPosition // Safe
		NOP
		JAL 	AlterMenuCode // Safe
		NOP
		...
		NOP
		JAL 	UpdateSlot3Arrays // Safe
		NOP
		JAL 	HandleSlot3 // Safe
		NOP
		JAL 	ResetCLagCounter // Safe
		NOP
		JAL 	ChangeMenuSlide // Safe
		NOP
		JAL 	HandleSecondSlide // Safe
		NOP
		// None of the below
...
// Tools Menu Corrections when closing menu
ToolsMenuCloseCorrect:
	SB 		r0, 0x807FFDC6
	LBU 	a0, @MenuOpen
	BEQZ 	a0, ToolsMenuCloseCorrect_Finish
	NOP
	LI 		a2, 1
	SB 		a2, 0x807FFDC6
	LH	 	a0, @NewlyPressedControllerInput
	ANDI 	a1, a0, @B_Button
	BEQZ 	a1, ToolsMenuCloseCorrect_CheckStart
	NOP
	LI 		a2, 2
	SB 		a2, 0x807FFDC6
	B 		ToolsMenuCloseCorrect_Corrections
	NOP

	ToolsMenuCloseCorrect_CheckStart:
		LI 		a2, 3
		SB 		a2, 0x807FFDC6
		ANDI 	a1, a0, @Start_Button
		BEQZ 	a1, ToolsMenuCloseCorrect_Finish
		NOP
		LI 		a2, 4
		SB 		a2, 0x807FFDC6

	ToolsMenuCloseCorrect_Corrections:
		SB 		r0, @MenuOpen
		SB  	r0, @MenuSlide 		
		LW 		a1, @PauseMenuTextPointer
		LW 		a2, @StoredMainMenuTextPointer
